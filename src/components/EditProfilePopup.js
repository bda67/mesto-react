    ...
    return(
        ...
        textButton={props.isLoading ? "Сохранение..." : "Сохранить"}>
            <fieldset className="popup__profile-info">    
                ...
                type="text" name="name" value={name || ''} minLength='2' maxLength='40' 
                ...
                placeholder="Вид деятельности" type="text" name="about" value={description || ''} 
                minLength='2' maxLength='200' onChange={handleDescription} required/>
